...
def test_infos_du_client():
    ...
    assert any(df_client.loc[df_client["SK_ID_CURR"] == 100038 , 'CODE_GENDER'] == 1)
    assert any(df_client.loc[df_client["SK_ID_CURR"] == 100038 , 'AMT_INCOME_TOTAL'] == 180000)
    assert any(df_client.loc[df_client["SK_ID_CURR"] == 100038 , 'AMT_CREDIT'] == 625500)
